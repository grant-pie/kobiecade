...
(function () {
  ...
  function drawMiniKobie(x) {
    ...
    ctx.beginPath(); ctx.ellipse(0, -44, 19, 22, 0, 0, Math.PI*2); ctx.fill();
    ...
    ctx.closePath(); ctx.fill();
    // Individual curls
    ctx.strokeStyle = hairCol; ctx.lineWidth = 4; ctx.lineCap = 'round';
    [
      ...
      ctx.bezierCurveTo(...pts[1], ...pts[2], ...pts[3]); ctx.stroke();
    });
    // Hair highlight
    ctx.strokeStyle = '#555553'; ctx.lineWidth = 1.5;
    ctx.beginPath(); ctx.moveTo(-6,-60); ctx.bezierCurveTo(-2,-56,2,-56,6,-60); ctx.stroke();
    // Face
